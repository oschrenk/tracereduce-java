...
public class CommandLine {
	...
	public static void main(final String[] args) {
		...
		final Precision precision = startupArguments.getPrecision();
		final Number epsilon = EpsilonFactory.build(
				startupArguments.getEpsilon(), precision);
		...
		final TraceReader traceReader = TraceReaders.build(precision,
				dimensions);
